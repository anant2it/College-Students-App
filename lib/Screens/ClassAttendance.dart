...
class OurClassAttendance extends StatefulWidget {
  final List<dynamic> list;
  final name;

  const OurClassAttendance({this.list, this.name});

  @override
  _OurClassAttendanceState createState() => _OurClassAttendanceState();
}

class _OurClassAttendanceState extends State<OurClassAttendance> {
  @override
