...
class OurClassNotice extends StatefulWidget {
  final List<dynamic> list;
  final name;

  const OurClassNotice({this.list, this.name});

  @override
  _OurClassNoticeState createState() => _OurClassNoticeState();
}

class _OurClassNoticeState extends State<OurClassNotice> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: widget.list.isEmpty
              ? Center(
                  child: Text("No Notices to display",
